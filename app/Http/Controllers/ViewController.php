...
class ViewController extends Controller
{
    public function index(){
        $result = DB::connection($this->db2)->select(`
        SELECT
    DISTINCT
	i.ITEMTYPEAFICODE,
...
LEFT JOIN (SELECT i2.SALESORDERCODE, i2.ORDERLINE, i2.LEBAR FROM ITXVIEWLEBAR i2) i2 ON i2.SALESORDERCODE = i.PROJECTCODE AND i2.ORDERLINE = i.ORIGDLVSALORDERLINEORDERLINE
WHERE
...
--    i4.WARNA = '15-4101 TCX'
	...
	i.DELIVERYDATE BETWEEN '2021-01-01' AND '2024-01-19' 
